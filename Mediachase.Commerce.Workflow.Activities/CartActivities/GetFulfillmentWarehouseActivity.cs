...
{
    public partial class GetFulfillmentWarehouseActivity : Mediachase.Commerce.Workflow.Activities.PurchaseOrderActivities.HandoffActivityBase
    {
        ...
        private string GetFulfillmentWarehouseForLineItem(OrderGroup orderGroup, LineItem lineItem)
        {
            ...
            var catalogKey = new Catalog.CatalogKey(lineItem.Parent.Parent.ApplicationId, lineItem.CatalogEntryId);
        ...
        private IWarehouse GetValidPickupFromShipment(OrderGroup orderGroup, LineItem lineItem, CheckInventoryMode checkInventory)
        {
            ...
            {
                var catalogKey = new Catalog.CatalogKey(lineApplicationId, lineItem.CatalogEntryId);
